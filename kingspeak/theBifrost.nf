#!/usr/bin/env nextflow
    ...
    params.singleReads  = "/scratch/general/lustre/u0854535/RNASeqData/SRA/sra/singleReads/*.fastq.gz"
    ...
    params.refFlat      = "/uufs/chpc.utah.edu/common/home/u0854535/referenceFiles/refFlat.txt.gz"
...
//Check for single end input reads
if (params.singleReads) { Channel.fromPath( "${params.singleReads}", checkIfExists:true )
    .int { singleReads_in }
    singleReadsPresent = true 
}
